...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_292 = "oninput" in document;
    if (!isSupported$jscomp$inline_292) {
      var element$jscomp$inline_293 = document.createElement("div");
      element$jscomp$inline_293.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_292 =
        "function" === typeof element$jscomp$inline_293.oninput;
    }
    JSCompiler_inline_result$jscomp$164 = isSupported$jscomp$inline_292;
...
for (
  var i$jscomp$inline_333 = 0;
  i$jscomp$inline_333 < simpleEventPluginEvents.length;
  i$jscomp$inline_333++
) {
  var eventName$jscomp$inline_334 =
      simpleEventPluginEvents[i$jscomp$inline_333],
    domEventName$jscomp$inline_335 = eventName$jscomp$inline_334.toLowerCase(),
    capitalizedEvent$jscomp$inline_336 =
      eventName$jscomp$inline_334[0].toUpperCase() +
      eventName$jscomp$inline_334.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_335,
    "on" + capitalizedEvent$jscomp$inline_336
  );
}
...
function attemptEarlyBailoutIfNoScheduledUpdate(
  ...
  switch (workInProgress.tag) {
    case 3:
      ...
      var root$103 = workInProgress.stateNode;
      pushProvider(workInProgress, CacheContext, current.memoizedState.cache);
      pooledCache = root$103.pooledCache;
      resetHydrationState();
      break;
    case 5:
    ...
    case 10:
      ...
      break;
    case 13:
      root$103 = workInProgress.memoizedState;
      if (null !== root$103) {
        if (null !== root$103.dehydrated)
          return (
      ...
      break;
    case 19:
      root$103 = 0 !== (renderLanes & workInProgress.childLanes);
            ...
            switch (firstChild.tag) {
              case 13:
                if (null !== firstChild.memoizedState) {
                  var current$128 = firstChild.alternate;
                  if (
                    null === current$128 ||
            ...
            if (0 !== (fiber$jscomp$0.flags & 8772))
              switch (fiber$jscomp$0.tag) {
                ...
                case 1:
                  ...
                  break;
                case 3:
                  var updateQueue$123 = fiber$jscomp$0.updateQueue;
                  if (null !== updateQueue$123) {
                    current = null;
                    ...
                    commitUpdateQueue(fiber$jscomp$0, updateQueue$123, current);
                  }
                  break;
                case 5:
                  var instance$125 = fiber$jscomp$0.stateNode;
                  null === current &&
                    fiber$jscomp$0.flags & 4 &&
                    ((current = instance$125),
...
var COMPONENT_TYPE = 0,
  ...
  TEXT_TYPE = 4;
if ("function" === typeof Symbol && Symbol.for) {
  var symbolFor$136 = Symbol.for;
  COMPONENT_TYPE = symbolFor$136("selector.component");
  HAS_PSEUDO_CLASS_TYPE = symbolFor$136("selector.has_pseudo_class");
  ROLE_TYPE = symbolFor$136("selector.role");
  TEST_NAME_TYPE = symbolFor$136("selector.test_id");
  TEXT_TYPE = symbolFor$136("selector.text");
}
...
var Internals = {
  ...
  devToolsConfig$jscomp$inline_1396 = {
...
var internals$jscomp$inline_1791 = {
  bundleType: devToolsConfig$jscomp$inline_1396.bundleType,
  version: devToolsConfig$jscomp$inline_1396.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1396.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1396.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1396.findFiberByHostInstance ||
