...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$164;
  if (canUseDOM) {
    var isSupported$jscomp$inline_290 = "oninput" in document;
    if (!isSupported$jscomp$inline_290) {
      var element$jscomp$inline_291 = document.createElement("div");
      element$jscomp$inline_291.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_290 =
        "function" === typeof element$jscomp$inline_291.oninput;
    }
    JSCompiler_inline_result$jscomp$164 = isSupported$jscomp$inline_290;
  } else JSCompiler_inline_result$jscomp$164 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$164 &&
...
for (
  var i$jscomp$inline_331 = 0;
  i$jscomp$inline_331 < simpleEventPluginEvents.length;
  i$jscomp$inline_331++
) {
  var eventName$jscomp$inline_332 =
      simpleEventPluginEvents[i$jscomp$inline_331],
    domEventName$jscomp$inline_333 = eventName$jscomp$inline_332.toLowerCase(),
    capitalizedEvent$jscomp$inline_334 =
      eventName$jscomp$inline_332[0].toUpperCase() +
      eventName$jscomp$inline_332.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_333,
    "on" + capitalizedEvent$jscomp$inline_334
  );
}
...
function attemptEarlyBailoutIfNoScheduledUpdate(
  ...
  switch (workInProgress.tag) {
    case 3:
      ...
      var root$105 = workInProgress.stateNode;
      pushProvider(workInProgress, CacheContext, current.memoizedState.cache);
      pooledCache = root$105.pooledCache;
      resetHydrationState();
      break;
    case 5:
    ...
    case 10:
      ...
      break;
    case 13:
      root$105 = workInProgress.memoizedState;
      if (null !== root$105) {
        if (null !== root$105.dehydrated)
          return (
    ...
    case 19:
      ...
      root$105 = 0 !== (renderLanes & workInProgress.childLanes);
      enableLazyContextPropagation &&
        !root$105 &&
        (propagateParentContextChanges(
          current,
            ...
            switch (firstChild$jscomp$0.tag) {
              case 13:
                if (null !== firstChild$jscomp$0.memoizedState) {
                  var current$130 = firstChild$jscomp$0.alternate;
                  if (
                    null === current$130 ||
                ...
                break;
              case 22:
                var isHidden$132 = null !== firstChild$jscomp$0.memoizedState,
                  current$133 = firstChild$jscomp$0.alternate,
                  wasHidden$134 =
                    null !== current$133 && null !== current$133.memoizedState;
                deletions = firstChild$jscomp$0;
                a: {
                  i = deletions;
                  childToDelete = isHidden$132;
        ...
        if (0 !== (fiber.flags & 8772))
          switch (fiber.tag) {
            ...
            case 1:
              ...
              break;
            case 3:
              var updateQueue$125 = fiber.updateQueue;
              if (null !== updateQueue$125) {
                current = null;
                if (null !== fiber.child)
                ...
                commitUpdateQueue(fiber, updateQueue$125, current);
              }
              break;
            case 5:
              var instance$127 = fiber.stateNode;
              null === current &&
                fiber.flags & 4 &&
                ((current = instance$127),
...
function commitRootImpl(root, renderPriorityLevel) {
  ...
  if (0 !== (finishedWork.subtreeFlags & 15990) || remainingLanes) {
    ...
    executionContext |= 4;
    ReactCurrentOwner$2.current = null;
    var shouldFireAfterActiveInstanceBlur$143 = commitBeforeMutationEffects(
      root,
      finishedWork
    );
    commitMutationEffects(root, finishedWork);
    shouldFireAfterActiveInstanceBlur$143 &&
      ((_enabled = !0),
...
function createFiberRoot(
  ...
  concurrentUpdatesByDefaultOverride = new Map();
...
_attemptSynchronousHydration = function(fiber) {
  switch (fiber.tag) {
    case 3:
      var root$145 = fiber.stateNode;
      if (root$145.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$145.pendingLanes);
        0 !== lanes &&
          (markRootEntangled(root$145, lanes | 1),
          ensureRootIsScheduled(root$145, now()),
          0 === (executionContext & 6) &&
...
var Internals = {
  ...
  devToolsConfig$jscomp$inline_1384 = {
...
var internals$jscomp$inline_1785 = {
  bundleType: devToolsConfig$jscomp$inline_1384.bundleType,
  version: devToolsConfig$jscomp$inline_1384.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1384.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1384.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1384.findFiberByHostInstance ||
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1786 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1786.isDisabled &&
    hook$jscomp$inline_1786.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1786.inject(
        internals$jscomp$inline_1785
      )),
        (injectedHook = hook$jscomp$inline_1786);
    } catch (err) {}
}
