...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$199;
  if (canUseDOM) {
    var isSupported$jscomp$inline_325 = "oninput" in document;
    if (!isSupported$jscomp$inline_325) {
      var element$jscomp$inline_326 = document.createElement("div");
      element$jscomp$inline_326.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_325 =
        "function" === typeof element$jscomp$inline_326.oninput;
    }
    JSCompiler_inline_result$jscomp$199 = isSupported$jscomp$inline_325;
  } else JSCompiler_inline_result$jscomp$199 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$199 &&
...
for (
  var i$jscomp$inline_366 = 0;
  i$jscomp$inline_366 < simpleEventPluginEvents.length;
  i$jscomp$inline_366++
) {
  var eventName$jscomp$inline_367 =
      simpleEventPluginEvents[i$jscomp$inline_366],
    domEventName$jscomp$inline_368 = eventName$jscomp$inline_367.toLowerCase(),
    capitalizedEvent$jscomp$inline_369 =
      eventName$jscomp$inline_367[0].toUpperCase() +
      eventName$jscomp$inline_367.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_368,
    "on" + capitalizedEvent$jscomp$inline_369
  );
}
...
function attemptEarlyBailoutIfNoScheduledUpdate(
  ...
  switch (workInProgress.tag) {
    case 3:
      ...
      var root$121 = workInProgress.stateNode;
      pushProvider(workInProgress, CacheContext, current.memoizedState.cache);
      pooledCache = root$121.pooledCache;
      resetHydrationState();
      break;
    case 5:
    ...
    case 12:
      0 !== (renderLanes & workInProgress.childLanes) &&
        (workInProgress.flags |= 4);
      root$121 = workInProgress.stateNode;
      root$121.effectDuration = 0;
      root$121.passiveEffectDuration = 0;
      break;
    case 13:
      root$121 = workInProgress.memoizedState;
      if (null !== root$121) {
        if (null !== root$121.dehydrated)
          return (
    ...
    case 19:
      ...
      root$121 = 0 !== (renderLanes & workInProgress.childLanes);
      enableLazyContextPropagation &&
        !root$121 &&
        (propagateParentContextChanges(
          current,
    ...
    if (0 !== (firstChild.subtreeFlags & 9236) && null !== root)
      ...
      for (; null !== nextEffect; ) {
        ...
        try {
          ...
          captureCommitPhaseError(firstChild, firstChild.return, error$147);
        }
            ...
            switch (firstChild$jscomp$0.tag) {
              case 13:
                if (null !== firstChild$jscomp$0.memoizedState) {
                  var current$160 = firstChild$jscomp$0.alternate;
                  if (
                    null === current$160 ||
                ...
                break;
              case 22:
                var isHidden$162 = null !== firstChild$jscomp$0.memoizedState,
                  current$163 = firstChild$jscomp$0.alternate,
                  wasHidden$164 =
                    null !== current$163 && null !== current$163.memoizedState;
                committedLanes = firstChild$jscomp$0;
                a: {
                  i = committedLanes;
                  childToDelete = isHidden$162;
  ...
  for (; null !== nextEffect; ) {
    ...
    if (0 !== (fiber.flags & 8772)) {
      ...
      try {
        ...
        if (0 !== (fiber.flags & 8772))
          switch (fiber.tag) {
            ...
            case 1:
              ...
              break;
            case 3:
              var updateQueue$151 = fiber.updateQueue;
              if (null !== updateQueue$151) {
                current = null;
                if (null !== fiber.child)
                ...
                commitUpdateQueue(fiber, updateQueue$151, current);
              }
              break;
            case 5:
              var instance$153 = fiber.stateNode;
              null === current &&
                fiber.flags & 4 &&
                ((current = instance$153),
        ...
        captureCommitPhaseError(fiber, fiber.return, error$168);
      }
    }
...
function reappearLayoutEffects_complete(subtreeRoot) {
  for (; null !== nextEffect; ) {
    ...
    try {
      ...
      captureCommitPhaseError(fiber, fiber.return, error$169);
    }
    if (fiber === subtreeRoot) {
      nextEffect = null;
      break;
...
_attemptSynchronousHydration = function(fiber) {
  switch (fiber.tag) {
    case 3:
      ...
      if (root$180.isDehydrated) {
        var lanes = getHighestPriorityLanes(root$180.pendingLanes);
        0 !== lanes &&
          (markRootEntangled(root$180, lanes | 1),
...
var Internals = {
  ...
  devToolsConfig$jscomp$inline_1468 = {
...
var internals$jscomp$inline_1887 = {
  bundleType: devToolsConfig$jscomp$inline_1468.bundleType,
  version: devToolsConfig$jscomp$inline_1468.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1468.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1468.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1468.findFiberByHostInstance ||
